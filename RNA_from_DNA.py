...
print("3' - " + str(reverse_dna_sequence))
print(" ")
...
reverse_transcript = reverse_dna_sequence.replace("T", "U")
...
print(" ")
print("The reverse RNA transcript is seen below. The program has identified " + str(count_start_codon(reverse_transcript)) + " start codons and " + str(count_stop_codon(reverse_transcript)) + " stop codons in this RNA sequence.")
print("3' - " + str(reverse_transcript))
print(" ")
...
notice_string = "The file will be saved under 'rna_seq.txt'. If you run this program again it will overwrite the file with the selected sequence, so it is recommended that you change the filename immediately."

if save_q1.lower() == "no":
    print("Okay. Program complete.")
    quit()
if save_q1.lower() == "yes":
    save_q2 = input("Okay. What sequence would you like to save? Please choose 'Forward', 'Reverse', 'Complimentary' or 'Reverse Complimentary': ")
    if save_q2.lower() == "forward":
        ...
        print(str(notice_string))           
    elif save_q2.lower() == "reverse":
        with open("rna_seq.txt", "w") as f:
            f.write("The DNA sequence input was:")
            f.write("\n")
            f.write("\n")
            ...
            f.write("\n")
            f.write("\n")
            f.write("The reverse RNA transcript returned is:")
            f.write("\n")
            f.write("\n")
            f.write(reverse_transcript)
        print(str(notice_string))
    elif save_q2.lower() == "complimentary":
        with open("rna_seq.txt", "w") as f:
            f.write("The DNA sequence input was:")
            f.write("\n")
            f.write("\n")
        ...
        print(str(notice_string))
    elif save_q2.lower() == "reverse complimentary":
        with open("rna_seq.txt", "w") as f:
            f.write("The DNA sequence input was:")
            f.write("\n")
            f.write("\n")
